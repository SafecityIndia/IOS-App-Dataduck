...
export class SafteytipfourPage implements OnInit {
  ...
  user_id
  buttondisable = true;
  constructor(private navController: NavController,public sharedservice:SharedService, private router: Router,private route: ActivatedRoute,public httpClient: HttpClient,) {
