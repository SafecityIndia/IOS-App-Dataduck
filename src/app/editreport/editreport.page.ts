...
baseURL = this.sharedservice.get_url()
  ...
  constructor(private route: ActivatedRoute,private navController: NavController, public sharedservice:SharedService,private router: Router,public httpClient:HttpClient) {
