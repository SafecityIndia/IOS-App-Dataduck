...
export class ReportfiledsevenPage implements OnInit {
  ...
  catstatus
  link: any;
  constructor(private navController: NavController,private sharedservice : SharedService, private router: Router, private route: ActivatedRoute, public httpClient: HttpClient) {
