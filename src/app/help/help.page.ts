...
export class HelpPage implements OnInit {
  ...
  constructor(private navController: NavController,public formBuilder: FormBuilder,private sharedservice : SharedService, private router: Router, public httpClient: HttpClient, private callNumber: CallNumber) {
