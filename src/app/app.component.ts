...
export class AppComponent {
  ...
  constructor(
    ...
    private splashScreen: SplashScreen,public router: Router,
    private translate: TranslateService,private network: Network,
    private statusBar: StatusBar,public navController:NavController,public zone: NgZone) {
    this.initializeApp();
