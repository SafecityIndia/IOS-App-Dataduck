...
export class OrganizationPage implements OnInit {
  ...
  orgList: any;
  buttondisable =true
  constructor(public httpClient:HttpClient,private sharedservice : SharedService, private router: Router,public navController:NavController,public route:ActivatedRoute) {
