...
let PreframingtwoPage = class PreframingtwoPage {
    constructor(navController, sharedservice, sanitizer, router) {
        ...
        this.sharedservice.sharedPostRequest('faq/getClientResourceList', data).subscribe((rdata) => {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_6__(".dynamic-success-link1").html(this.content);
            ...
            jquery__WEBPACK_IMPORTED_MODULE_6__("#estimate").click(function (event) {
                ...
                if (jquery__WEBPACK_IMPORTED_MODULE_6__(this).is(":checked")) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_6__(".dynamic-click").removeAttr("disabled");
                    // $(".checkerrors").hide()
                }
